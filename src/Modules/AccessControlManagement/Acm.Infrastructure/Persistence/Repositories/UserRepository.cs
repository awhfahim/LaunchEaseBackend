...
public class UserRepository : IUserRepository
{
    ...
    public async Task<bool> EmailExistsAsync(string email, Guid tenantId, CancellationToken cancellationToken = default)
    {
        ...
        return await connection.QueryFirstOrDefaultAsync<int?>(sql, new { Email = email, TenantId = tenantId }) is not null;
    }
    ...
    public async Task SetLockoutEndAsync(Guid id, DateTimeOffset? lockoutEnd, CancellationToken cancellationToken = default)
    {
        using var connection = await _connectionFactory.OpenConnectionAsync();
    ...
    public async Task SetSecurityStampAsync(Guid id, string securityStamp, CancellationToken cancellationToken = default)
    {
        using var connection = await _connectionFactory.OpenConnectionAsync();
